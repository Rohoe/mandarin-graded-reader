...
export function actions(dispatch) {
  return {
    ...
    setExportSentenceRom:  (langId, val) => dispatch({ type: 'SET_EXPORT_SENTENCE_ROM', payload: { langId, value: Boolean(val) } }),
    setExportSentenceTrans:(langId, val) => dispatch({ type: 'SET_EXPORT_SENTENCE_TRANS', payload: { langId, value: Boolean(val) } }),
