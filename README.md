...
- **Verbose Vocabulary** — Toggle in Settings to show English translations below each example sentence in the vocabulary section and comprehension questions; translations are also included in Anki exports when enabled
